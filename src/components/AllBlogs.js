        ...
        <div className='RightHomeSection'>
          ...
          <div className='popularsec' >
            ...
            {[...posts]
              ...
              .map((post) => (
                <Link style={{ textDecoration: 'none', color: 'black' }} key={post._id} to={`${FRONTEND_APP_URL}/blog/${post._id}`}>
          ...
          {posts.length === 0 ? (<p>No Posts Found!</p>) : (
            <div className='recentposts'>
              ...
              {posts
                ...
                .map((post) => (
                  <Link style={{ textDecoration: 'none', color: 'black' }} to={`${FRONTEND_APP_URL}/blog/${post._id}`}>
